...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/nathanmcguire/nexus/tree/main/packages/create-docusaurus/templates/shared/',
        },
        // blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Nathan McGuire`,
    },
    prism: {
